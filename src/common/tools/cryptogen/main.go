...
import (
	...
	"github.com/foglink/fnkcore/src/common/tools/cryptogen/ca"
	"github.com/foglink/fnkcore/src/common/tools/cryptogen/csp"
	"github.com/foglink/fnkcore/src/common/tools/cryptogen/metadata"
	"github.com/foglink/fnkcore/src/common/tools/cryptogen/msp"
...
PeerOrgs:
  ...
  - Name: Org1
    ...
    #    OrganizationalUnit: foglink fnkcore
...
//command line flags
var (
	app = kingpin.New("cryptogen", "Utility for generating foglink fnkcore key material")
