...
import (
	...
	"github.com/foglink/fnkcore/src/common/tools/configtxlator/metadata"
	"github.com/foglink/fnkcore/src/common/tools/configtxlator/rest"
	"github.com/foglink/fnkcore/src/common/tools/configtxlator/update"
	"github.com/foglink/fnkcore/src/common/tools/protolator"
...
// command line flags
var (
	app = kingpin.New("configtxlator", "Utility for generating foglink fnkcore channel configurations")
