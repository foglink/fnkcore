...
def getExample02ChaincodeSpec():
    return getChaincodeSpec("GOLANG", "github.com/foglink/fnkcore/src/examples/chaincode/go/chaincode_example02", "example02", ["init","a","100","b","200"])



def _createDeploymentSpecAsFile(ccSpec, outputPath):
    '''peer chaincode package -n myCC -c '{"Args":["init","a","100","b","200"]}' -p github.com/foglink/fnkcore/src/examples/chaincode/go/chaincode_example02 --logging-level=DEBUG test.file'''
