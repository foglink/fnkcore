...
import (
	...
	"github.com/foglink/fnkcore/src/common/metadata"
	"github.com/foglink/fnkcore/src/core/chaincode/platforms/util"
	ccmetadata "github.com/foglink/fnkcore/src/core/common/ccprovider/metadata"
	cutil "github.com/foglink/fnkcore/src/core/container/util"
...
func (goPlatform *Platform) GetDeploymentPayload(spec *pb.ChaincodeSpec) ([]byte, error) {
	...
	var provided = map[string]bool{
		"github.com/foglink/fnkcore/src/core/chaincode/shim": true,
		"github.com/foglink/fnkcore/src/protos/peer":         true,
	}
	...
	for _, file := range files {
		...
		// original file.Name:  src/github.com/foglink/fnkcore/src/examples/chaincode/go/marbles02/META-INF/statedb/couchdb/indexes/indexOwner.json
