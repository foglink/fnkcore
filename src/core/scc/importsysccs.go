...
import (
	...
	"github.com/foglink/fnkcore/src/core/scc/cscc"
	"github.com/foglink/fnkcore/src/core/scc/escc"
	"github.com/foglink/fnkcore/src/core/scc/lscc"
	"github.com/foglink/fnkcore/src/core/scc/qscc"
	"github.com/foglink/fnkcore/src/core/scc/vscc"
)
...
var systemChaincodes = []*SystemChaincode{
	{
		Enabled:           true,
		Name:              "cscc",
		Path:              "github.com/foglink/fnkcore/src/core/scc/cscc",
		InitArgs:          [][]byte{[]byte("")},
	...
	},
	{
		Enabled:           true,
		Name:              "lscc",
		Path:              "github.com/foglink/fnkcore/src/core/scc/lscc",
		InitArgs:          [][]byte{[]byte("")},
	...
	},
	{
		Enabled:   true,
		Name:      "escc",
		Path:      "github.com/foglink/fnkcore/src/core/scc/escc",
		InitArgs:  [][]byte{[]byte("")},
	...
	},
	{
		Enabled:   true,
		Name:      "vscc",
		Path:      "github.com/foglink/fnkcore/src/core/scc/vscc",
		InitArgs:  [][]byte{[]byte("")},
	...
	},
	{
		Enabled:           true,
		Name:              "qscc",
		Path:              "github.com/foglink/fnkcore/src/core/chaincode/qscc",
		InitArgs:          [][]byte{[]byte("")},
